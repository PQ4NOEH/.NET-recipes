...
{
    public class PortalPacientePaymentGatewayContext : DbContext, ISynchroDbContext<GatewayAggregate>
    {
        public ESynchroSystem SynchroSystem
        {
            get { return ESynchroSystem.PortalPaciente; }
        }
        public PortalPacientePaymentGatewayContext(IHostConfiguration hostConfiguration)
            : base("PortalPaciente")
        {
            Database.SetInitializer<PortalPacientePaymentGatewayContext>(null);
        }
