...
{
    public class VisionLocalPayableContext : DbContext, ISynchroDbContext<PayableAggregate>
    {
        public ESynchroSystem SynchroSystem
        {
            get { return ESynchroSystem.VisionLocal; }
        }
        public VisionLocalPayableContext(IHostConfiguration hostConfiguration)
            : base("VisionLocal")
        {
            Database.SetInitializer<VisionLocalPayableContext>(null);
        }
