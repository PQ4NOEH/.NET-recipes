...
{
    public class VisionLocalQuestionnaireContext : DbContext, ISynchroDbContext<QuestionnaireAggregate>
    {
        public ESynchroSystem SynchroSystem
        {
            get { return ESynchroSystem.VisionLocal; }
        }
        public VisionLocalQuestionnaireContext(IHostConfiguration hostConfiguration)
            : base("VisionLocal")
        {
            Database.SetInitializer<VisionLocalQuestionnaireContext>(null);
        }
