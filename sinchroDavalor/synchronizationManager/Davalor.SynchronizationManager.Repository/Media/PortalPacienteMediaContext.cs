...
{
    public class PortalPacienteMediaContext : DbContext, ISynchroDbContext<MediaAggregate>
    {
        public ESynchroSystem SynchroSystem
        {
            get { return ESynchroSystem.PortalPaciente; }
        }
        public PortalPacienteMediaContext(IHostConfiguration hostConfiguration)
            : base("PortalPaciente")
        {
