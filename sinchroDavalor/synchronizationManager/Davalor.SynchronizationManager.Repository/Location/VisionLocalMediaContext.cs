...
{
    public class VisionLocalLocationContext : DbContext, ISynchroDbContext<LocationAggregate>
    {
        public ESynchroSystem SynchroSystem
        {
            get { return ESynchroSystem.VisionLocal; }
        }
        public VisionLocalLocationContext(IHostConfiguration hostConfiguration)
            : base("VisionLocal")
        {
