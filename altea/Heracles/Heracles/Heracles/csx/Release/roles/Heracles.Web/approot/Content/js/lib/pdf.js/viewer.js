...
/* globals PDFJS, PDFBug, FirefoxCom, Stats, Cache, ProgressBar,
    ...
    var DEFAULT_URL = "/WiseReader/File/" + window.model.fileId;
    ...
    PDFJS.imageResourcesPath = "/Content/img/lib/pdf.js/";
    PDFJS.workerSrc = "/Content/js/lib/pdf.js/pdf.worker.js";
    PDFJS.cMapUrl = "/Content/js/lib/pdf.js/cmaps/";
        ...
        open: function pdfViewOpen(file, scale, password,
            ...
            PDFJS.getDocument(parameters, pdfDataRangeTransport, passwordNeeded,
                ...
                function getDocumentCallback(pdfDocument) {
                    window.top.window.wisereader.loaded();
