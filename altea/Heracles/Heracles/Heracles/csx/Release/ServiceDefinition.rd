...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="Heracles" generation="1" functional="0" release="0" Id="994ee8fe-d9b1-4ceb-9e8d-cf2fb905a14e" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="HeraclesGroup" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="Heracles.Web" generation="1" functional="0" release="0" software="C:\Altea\Heracles\Heracles\Heracles\csx\Release\roles\Heracles.Web" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaIISHost.exe " memIndex="-1" hostingEnvironment="frontendadmin" hostingEnvironmentVersion="2">
            <componentports>
        ...
        <groupHascomponents>
          <role name="Heracles.Worker" generation="1" functional="0" release="0" software="C:\Altea\Heracles\Heracles\Heracles\csx\Release\roles\Heracles.Worker" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="fdbe756d-07ce-4f8a-bdd5-8c9aae4e8e42" ref="Microsoft.RedDog.Contract\ServiceContract\HeraclesContract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="0a713621-288b-497c-b003-940e0c237be2" ref="Microsoft.RedDog.Contract\Interface\Heracles.Web:HttpEndpoint@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/Heracles/HeraclesGroup/Heracles.Web:HttpEndpoint" />
          </inPort>
        </interfaceReference>
        <interfaceReference Id="6a901fa8-a9bc-4d65-ab89-adc1108a9411" ref="Microsoft.RedDog.Contract\Interface\Heracles.Worker:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/Heracles/HeraclesGroup/Heracles.Worker:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput" />
          </inPort>
        </interfaceReference>
